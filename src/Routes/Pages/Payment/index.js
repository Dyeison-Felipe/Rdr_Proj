        ...
        return (
          <div>
            <span className="boleton">
              O Pagamento deve ser realizado em 2-3 dias úteis até o prazo de seu vencimento em uma casa lotérica ou em caixas bancários.
            </span>
          </div>
        );
      };
        ...
        <div className="pagamento-c">
            <div className="campos-pagamento-c">
                <div className="cupom-desconto-c">
                    ...
                    <input className="campo-cupom-c" placeholder="Você possui um cupom de desconto? Digite aqui"/>
                    <button className="campo-botao-c" onClick={() => setCupomDescontoAdicionado(true)}>OK</button>
                    {cupomDescontoAdicionado && <DescontoForm />}
                </div>
                <div className="formas-pagamento-c">
                    <span>Pagamento</span>

                    <div className="pagamento-geral-c" onClick={() => setFormaPagamento("Pix")}>
                        <div className="selecionar-pagamento-c">
                            <input type="radio" id="pix-c" name="formapagamento"/>
                            <svg width="25" height="20" viewBox="0 0 40 40" fill="none" className="nofill">
                                <path
                    ...
                    <div className="pagamento-geral-c">
                        ...
                        <input
                          type="radio"
                          id="cartao-credito-c" name="formapagamento" onClick={() => {
                    ...
                    <div className="pagamento-geral-c" onClick={() => setFormaPagamento("Boleto")}>
                        <div className="selecionar-pagamento-c">
                            ...
                            <svg width="25" height="20" viewBox="0 0 40 40" fill="none" className="nofill">
                                <path
                                    ...
                                    fill="#fff" stroke="#000" stroke-width="0.8"></path>
                                <path d="M8.368 12H3v16h5.368V12z" fill="#000"></path>
                                <path d="M8.368 12H3v16h5.368V12z" fill="#000"></path>
                                <path d="M8.368 12H3v16h5.368V12z" fill="#000"></path>
                                <path d="M8.368 12H3v16h5.368V12zM28.053 12h-5.369v16h5.369V12z" fill="#000"></path>
                                <path d="M28.053 12h-5.369v16h5.369V12z" fill="#000"></path>
                                <path d="M28.053 12h-5.369v16h5.369V12z" fill="#000"></path>
                                <path d="M28.053 12h-5.369v16h5.369V12zM10.158 12h1.79v16h-1.79V12z" fill="#000"></path>
                                <path d="M10.158 12h1.79v16h-1.79V12z" fill="#000"></path>
                                <path d="M10.158 12h1.79v16h-1.79V12z" fill="#000"></path>
                                <path d="M10.158 12h1.79v16h-1.79V12zM13.737 12h3.579v16h-3.58V12z" fill="#000"></path>
                                <path d="M13.737 12h3.579v16h-3.58V12z" fill="#000"></path>
                                <path d="M13.737 12h3.579v16h-3.58V12z" fill="#000"></path>
                                <path d="M13.737 12h3.579v16h-3.58V12zM29.842 12h3.58v16h-3.58V12z" fill="#000"></path>
                                <path d="M29.842 12h3.58v16h-3.58V12z" fill="#000"></path>
                                <path d="M29.842 12h3.58v16h-3.58V12z" fill="#000"></path>
                                <path d="M29.842 12h3.58v16h-3.58V12zM19.105 12h1.79v16h-1.79V12z" fill="#000"></path>
                                <path d="M19.105 12h1.79v16h-1.79V12z" fill="#000"></path>
                                <path d="M19.105 12h1.79v16h-1.79V12z" fill="#000"></path>
                                <path d="M19.105 12h1.79v16h-1.79V12zM35.21 12H37v16h-1.79V12z" fill="#000"></path>
            ...
            <div className="valor-final-c">
                ...
                <div>
                  <Link className="campo-botao-final-c" to="/orderplaced-finalizacao">Finalizar Pedido</Link>
                </div>
            </div>
        </div>
    </div></>
